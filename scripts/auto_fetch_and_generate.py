...
==========================
Standalone script â€” no FastAPI, no SQLModel.
...
# â”€â”€ Try to load .env from parent dir (project root) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
try:
...
# â”€â”€ OTX Fetch â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def fetch_otx_iocs(limit: int = 50, dry_run: bool = False) -> dict:
    ...
    # â”€â”€ 1. Load target CVEs from DB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    con = get_db()
    cur = con.cursor()
    rows = cur.execute(
    ...
    # â”€â”€ 2. Concurrent OTX fetch â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 3. Dedup and insert into DB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 4. Update fetchlog â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Rule Generation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def print_summary_table(stats: dict) -> None:
    ...
    print("="*60)
    rows = [
        ("Total CVEs in DB",      stats.get("cve_count",     "â€”")),
        ("KEV CVEs in DB",        stats.get("kev_count",     "â€”")),
        ("CVEs Queried (OTX)",    stats.get("cves_queried",  "â€”")),
        ("IoCs Added",            stats.get("iocs_added",    "â€”")),
        ("Total IoCs in DB",      stats.get("ioc_count_after", "â€”")),
        ("Snort Rules Generated", stats.get("snort_rules",   "â€”")),
        ("Sigma Rules Generated", stats.get("sigma_rules",   "â€”")),
        ("JSON Alerts Generated", stats.get("json_alerts",   "â€”")),
        ("OTX Errors",            stats.get("otx_errors",    "â€”")),
    ]
...
def main() -> None:
    ...
    log_section("Vulnerability Tracker â€” OTX Fetch & Rule Generation")
    log(f"DB path:      {DB_PATH}")
    log(f"Output dir:   {OUTPUT_DIR}")
    log(f"OTX API key:  {'SET (' + OTX_API_KEY[:8] + '...)' if OTX_API_KEY else 'NOT SET'}")
    log(f"Dry-run:      {args.dry_run}")

    # â”€â”€ Step 1: Verify DB state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    initial_state = verify_db()
    log(f"Initial state â†’ CVEs: {initial_state['cve_count']}, "
    ...
    # â”€â”€ Step 2: Fetch OTX IoCs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Step 3: Generate Rules â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if not args.otx_only:
        rule_result = generate_all_rules(dry_run=args.dry_run)
        stats.update(rule_result)

    # â”€â”€ Final DB state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
